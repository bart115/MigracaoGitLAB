...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g029.git
$ cd 2022li1g029
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g029.git
$ cd 2022li1g029
```
...
- **A104010** Vitor Miguel Almeida RIbeiro;
- **A104350** Gonçalo Freitas;
