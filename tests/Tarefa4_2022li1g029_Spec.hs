...
testsT4 :: Test
testsT4 = TestLabel "Testes Tarefa 4" $ test ["Teste1,se o jogador saiu pelo lado direito do mapa na Relva" ~: True  ~=? jogoTerminou1 (Jogo (Jogador (5,5)) (Mapa 4 [(Relva,[Nenhum,Nenhum,Arvore])]))
